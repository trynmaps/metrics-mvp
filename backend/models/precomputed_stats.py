...
class PrecomputedStats:
    ...
    def get_trip_time_stats(self, route_id, direction_id, start_stop_id, end_stop_id):
        start_stop_stats = self.get_stop_stat_value(
            route_id, direction_id, "tripTimes", start_stop_id
        )
    ...
    def get_median_trip_time(self, route_id, direction_id, start_stop_id, end_stop_id):
        trip_time_stats = self.get_trip_time_stats(
...
def get_precomputed_stats(
    agency_id, stat_id: str, d: date, start_time_str=None, end_time_str=None, version=DefaultVersion
) -> PrecomputedStats:
...
def get_s3_path(
    agency_id: str, stat_id: str, d: date, start_time_str, end_time_str, version=DefaultVersion
) -> str:
