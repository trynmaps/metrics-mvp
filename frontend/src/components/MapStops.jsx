...
class MapStops extends Component {
  ...
  populateRouteDirection = (routeStops, direction_id, color, radius, direction) => {
    ...
    if (routeStops && routeStops[direction_id]) {
      ...
      route.unshift(<Polyline key={'polyline-' + direction_id} color={color} positions={routeStops[direction_id]} />);
    }
    return route;
  }
  
  // TODO: handle end stop being upstream of start stop by swapping them.  Backend returns negative values otherwise.
