...
class UtilTest(unittest.TestCase):
    ...
    def test_get_dates_in_range(self):
        self.assertEqual(
            util.get_dates_in_range("2019-12-27", "2019-12-27"), [datetime.date(2019, 12, 27)]
        )
        self.assertEqual(
    ...
    def test_haver_distance(self):
        ...
        self.assertEqual(
            np.round(util.haver_distance(lat1, lon1, lat2, lon2), 2).tolist(), [369.11, 1737.08]
        )
        ...
        self.assertEqual(
            np.round(util.haver_distance(lat1[0], lon1[0], lat2[0], lon2[0]), 2), 369.11
        )
